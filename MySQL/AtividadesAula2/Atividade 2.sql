...
insert into tb_categoria (nomePizzaiolo, sabor, adicional) values ("Julio Pizzaiolo", "salgado", true);
insert into tb_categoria (nomePizzaiolo, sabor, adicional) values ("Bá Pizzaiola", "doce", false);
insert into tb_categoria (nomePizzaiolo, sabor, adicional) values ("Alysan Babyzzaiolo", "salgado", false);
insert into tb_categoria (nomePizzaiolo, sabor, adicional) values ("Gabis Pizzazinha", "doce", true);
insert into tb_categoria (nomePizzaiolo, sabor, adicional) values ("Vitor Churros", "doce", false);
